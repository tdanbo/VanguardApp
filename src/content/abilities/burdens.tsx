...
export const burden_content: Record<string, AbilityStatic> = {
  ...
  Paws: {
    novice: {
      description:
        "Andriks have poorly developed hands, and thus have a hard time performing delicate tasks such as creating something with their hands, pick a lock or similar. As soon as a test requires sleight, or dexterity, of hand the andrik rolls twice and pick the worst result (ANDRIK ONLY)",
      action: "",
      roll: [],
    },
    adept: {
  ...
  Wanted: {
    novice: {
      description:
        "The character is wanted for a serious crime, either justly or falsely accused. The effect is that he or she risks getting recognized and hunted. Once per adventure, the character must pass a Sneaking test to avoid being identified.",
      action: "",
      roll: [],
    },
    adept: {
